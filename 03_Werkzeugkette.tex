...
% def. software konfig verwaltung
\definition[1]{Softwarekonfigurationsverwaltung}{ (engl. software configuration management) ist die Disziplin zur Verfolgung und Steuerung der Evolution von Software}
% def. software konfig
\definition[1]{(Software-) Konfiguration}{ist eine \babyblue{eindeutig bekannte} Menge von \babyblue{Software-Elementen}, mit den jeweils gültigen \babyblue{Versionsangaben}, die zu einem bestimmten Zeitpunkt im Produktlebenszyklus in ihrer Wirkungsweise und ihren Schnittstellen aufeinander abgestimmt sind und gemeinsam eine vorgesehene Aufgabe erfüllen sollen. }
% def. software element
\definition[0]{Software-Element}{ist jeder identifizierbare Bestandteil eines Produktes oder einer Produktlinie. Ein Software-Element kann eine einzelne Datei sein, oder auch eine Konfiguration.}
...
\definition[0]{Depot}{Ein \babyblue{Depot} (engl. Repository) ist ein verwaltetes Verzeichnis zur Speicherung und Beschreibung digitaler Objekte für ein digitales Archiv. Software-Elemente werden in \babyblue{Depots} gespeichert.}
...
\definition[0]{Kopfzeiger}{Der Kopfzeiger (engl. HEAD-Pointer) zeigt auf aktuellen Zustand des Arbeitsordners in der Versionshistorie.}
