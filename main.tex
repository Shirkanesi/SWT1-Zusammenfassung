...
\subfile{Werkzeugkette}
\newpage

\subfile{Planungsphase}
\newpage

\subfile{UML}
\subfile{UML-Diagramme}
\newpage

\subfile{ModularerEntwurf}
\newpage

\subfile{Architekturstile}
\newpage

\subfile{Entwurfsmuster}
\newpage

\subfile{Entwurfsphase}
\newpage

\subfile{Implementierungsphase}
\newpage

\subfile{Parallelitaet}
\newpage
